...
const translateY = useTransform(scrollYProgress, [0, 1], [150, -150]);
  ...
  <div className="container">
    ...
    <div className="md:w-[478px]">
      ...
      <h1 className="text-5xl md:text-7xl font-bold tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text mt-24">Pathway to productivity</h1>
  ...
  />
  <motion.img 
  src={noodleImage.src} width={220} alt="Noodle Image" className="hidden lg:block absolute top-[524px] left-[448px] rotate-[30deg] "
  style={{
    rotate:30,
      translateY:translateY,
    }}
